    ...
    insertReservation: (req, res) => {
        ...
        .then(result => {
            ...
            Object.keys(result).forEach((key) => {
                ...
                reservation.actionReservation([hotel_id, user_id, invoice, reservation_date, num_people, bed_type, room_number, price, plan_checkin, plan_checkout])
                    .then(row => {
                        res.json({
                            success: true,
